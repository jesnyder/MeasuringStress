...
from c0103_find_recordend import find_recordend
    ...
    for study in study_list:
        ...
        for sensor in sensor_list:
            ...
            for record in source_path:
                ...
                colName = str(str(sensor) + '_' + str(segment) + '_mean')
                dfStatistics[colName] = dfMeanList
                colName = str(str(sensor)  + '_' + str(segment) +  '_median')
                # dfStatistics[colName] = dfMedianList
                colName = str(str(sensor)  + '_' + str(segment) +  '_pvariance')
                dfStatistics[colName] = dfPvariance
                colName = str(str(sensor)  + '_' + str(segment) +  '_stdev')
                dfStatistics[colName] = dfStdev

                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_10')] = quan_10
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_20')] = quan_20
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_30')] = quan_30
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_40')] = quan_40
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_50')] = quan_50
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_60')] = quan_60
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_70')] = quan_70
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_80')] = quan_80
                dfStatistics[str(str(sensor)  + '_' + str(segment) +  'quan_90')] = quan_90
